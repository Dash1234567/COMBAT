...
const COACH_PANEL = {
  ...
  general: {
    ...
    coaches: [
      ...
      { name: 'Dietary Coach', focus: 'Meal planning & phase nutrition' },
...
const ENTRIES = [
  ...
  // -------------------------------------------------------------- TRAINING PHASES
  {
    title: 'Off-season: build your engine and your armor',
    sports: ['all'],
    keywords: ['off season', 'offseason', 'base building', 'build muscle', 'get stronger', 'bulk', 'put on size', 'base phase'],
    body: "The off-season is for building what you can't build in a fight camp: maximal strength, muscle, work capacity and fixing weak links. Lift heavy 2–3x/week, build an aerobic base, and keep skill work technical rather than all-out. Recovery is generous here — sleep and full rest days are when you actually grow. Nutrition: eat in a slight surplus with high protein (1.6–2.2 g/kg). Don't diet hard now — bank the strength and muscle you'll sharpen later.",
    sources: ['Strength Coach', 'Dietary Coach', 'Morgan Flaharty'],
  },
  {
    title: 'Pre-season: turn strength into sport-specific power',
    sports: ['all'],
    keywords: ['pre season', 'preseason', 'ramp up', 'build conditioning', 'sharpening', 'before camp', 'getting ready'],
    body: "Pre-season bridges the gap to competition. Convert off-season strength into power with jumps, throws and faster lifts, and ramp up sport-specific conditioning and sparring toward competition pace. Volume rises, so monitor fatigue and protect one full rest day plus a weekly mobility session. Nutrition: eat around maintenance, dial in body composition, and put carbs around your hardest sessions to keep quality high.",
    sources: ['Endurance Coach', 'Strength Coach', 'Dietary Coach'],
  },
  {
    title: 'Fight camp: peak, taper, and make weight right',
    sports: ['all', 'boxing', 'wrestling'],
    keywords: ['fight camp', 'training camp', 'pre tournament', 'peaking', 'peak', 'taper', 'final weeks', 'before the fight', 'before competition', 'fight week'],
    body: "Fight camp (the pre-tournament phase) is about sharpening, not building. Skills, sparring and sport-specific conditioning take centre stage, while strength drops to short, low-volume maintenance so you stay powerful without fatigue. Recovery becomes performance — protect sleep, use mobility, and taper/deload in the final week. Nutrition: manage weight gradually (~0.5–1% of bodyweight per week), keep protein high to hold muscle, then follow a rehearsed rehydration and refuel plan after the weigh-in.",
    sources: ['Boxing Science — Danny Wilson & Alan Ruddock', 'Wrestling Mindset', 'Dietary Coach'],
  },
  {
    title: 'Periodizing your year: off-season, pre-season & fight camp',
    sports: ['all'],
    keywords: ['periodization', 'periodize', 'phases', 'phase', 'training year', 'plan my year', 'macrocycle', 'how to structure', 'time of year'],
    body: "Smart athletes train in phases. Off-season: build the base — strength, work capacity and weaknesses, eating in a slight surplus. Pre-season: ramp up — turn strength into power and build sport-specific conditioning toward competition pace. Fight camp: peak and sharpen — heavy skills, sparring and conditioning while strength becomes maintenance, recovery becomes king, and you manage weight into a taper. COMBAT builds your calendar around exactly these phases so you always know what to do.",
    sources: ['Strength Coach', 'Dietary Coach', 'Boxing Science — Danny Wilson & Alan Ruddock'],
  },
  {
    title: 'Eating for your training phase',
    sports: ['all'],
    keywords: ['diet', 'dietary', 'meal plan', 'meal planning', 'nutrition plan', 'how to eat', 'training phase', 'eating', 'macros by phase', 'what to eat each phase'],
    body: "Match your diet to your phase. Off-season: a slight surplus to build, protein 1.6–2.2 g/kg, plenty of whole-food carbs. Pre-season: around maintenance, leaning out slowly if needed while fueling rising volume. Fight camp: a controlled deficit to make weight gradually, protein kept high to protect muscle, carbs timed around key sessions, then a practised rehydration + refuel after the weigh-in. Every phase: hydrate well, build meals around protein and vegetables, and never try anything new on competition day.",
    sources: ['Dietary Coach', 'Sports Nutritionist'],
  },
...
const SUGGESTIONS = {
  ...
  general: [
    'How should I eat for my training phase?',
    'How do I train in the off-season?',
    'What should I do during fight camp?',
